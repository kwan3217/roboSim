...
private:
  ...
  static const int ODOMETER_ADDRESS=0x55;
  static const int GYROSCOPE_ADDRESS=0x1E;
  char gpsBuf[128];
...
private:
  FILE* blaster;
  HardwarePiServoBlaster hardSteering;
  HardwarePiServoBlaster hardThrottle;
public:
...
private:
  FILE* blaster;
  HardwarePiServoArduino hardSteering;
  HardwarePiServoArduino hardThrottle;
public:
