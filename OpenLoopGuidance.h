...
private:
  ...
  int currentRow;
public:
  OpenLoopGuidance(Interface& Linterface, double* Lt, char* LservoChannel, int* LservoSetting):interface(Linterface),t(Lt),servoChannel(LservoChannel),servoSetting(LservoSetting),currentRow(0) {};
